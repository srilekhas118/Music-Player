...
let ResetPassword = ()=>{
    ...
    return <section className="h-[calc(100vh-70px)] w-[100%] flex justify-center items-center ">
        <article className=" w-[27%] bg-slate-700 py-4 px-6 rounded-md">
            <header className="text-center text-[24px] font-semibold"><h1>Reset Password</h1></header>
            <main>
                <form onSubmit={handleSubmit} action="" className="flex flex-col gap-2">
                    ...
                    <div className="mt-3">
                        <button className="bg-blue-600 w-[100%] py-1 rounded-md cursor-pointer hover:bg-blue-800">Reset Password</button>
                    </div>
                    <div className="mt-3">
                        <NavLink to={"/login"}> <button className="bg-red-600 w-[100%] py-1 rounded-md cursor-pointer hover:bg-red-800">Cancel</button></NavLink>
                    </div>
                </form>
            </main>
        </article>
